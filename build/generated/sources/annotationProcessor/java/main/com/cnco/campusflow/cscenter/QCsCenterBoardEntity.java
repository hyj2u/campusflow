...
/**
 * QCsCenterBoardEntity is a Querydsl query type for CsCenterBoardEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QCsCenterBoardEntity extends EntityPathBase<CsCenterBoardEntity> {

    private static final long serialVersionUID = -1397126222L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCsCenterBoardEntity csCenterBoardEntity = new QCsCenterBoardEntity("csCenterBoardEntity");
    ...
    public QCsCenterBoardEntity(String variable) {
        this(CsCenterBoardEntity.class, forVariable(variable), INITS);
    }

    public QCsCenterBoardEntity(Path<? extends CsCenterBoardEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCsCenterBoardEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCsCenterBoardEntity(PathMetadata metadata, PathInits inits) {
        this(CsCenterBoardEntity.class, metadata, inits);
    }

    public QCsCenterBoardEntity(Class<? extends CsCenterBoardEntity> type, PathMetadata metadata, PathInits inits) {
